...
const DefaultStore = () => {
  ...
  store.dispatch(
    addReview(defaultMovieIds[0], "Adolf", "8", "It was very good, I swear.")
  );
  store.dispatch(
    addReview(
      defaultMovieIds[0],
  ...
  store.dispatch(
    addReview(defaultMovieIds[1], "Eboka", "7", "Overrated, depressing")
  );
  store.dispatch(
    addReview(defaultMovieIds[3], "Hitesh", "10", "My favorite Movie")
  );
  store.dispatch(
    addReview(
      defaultMovieIds[0],
